...
import { datetime, useMedia } from '@/lib';
import * as React from 'react';
import { BackLink, InvoiceActions, StatusButton, Text } from '../atoms';
import { InvoiceItemDetails } from '../molecules';
...
const InvoiceDetails = ({ invoice, updateStatus }: Props) => {
