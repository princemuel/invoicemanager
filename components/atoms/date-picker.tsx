...
import { DateFormatter, DayPicker, DayContent, DayContentProps } from 'react-day-picker';
...
export function DatePicker({
  ...
  return (
    <DayPicker
      ...
      className={cn('rounded-lg px-5 pb-8 pt-6 shadow-200', className)}
      classNames={{
      ...
      components={{
        IconLeft: ({ className }) => <icons.chevron.left className={className} />,
        IconRight: ({ className }) => <icons.chevron.right className={className} />,
        DayContent: (props) => {
          return (
