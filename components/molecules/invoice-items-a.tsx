          ...
          return (
            ...
            >
              ...
              >
                <button
                  type='button'
                  className='inline-block h-[1.6rem] w-[1.3rem] bg-[url(/assets/icon-delete.svg)] bg-cover bg-no-repeat hover:bg-[url(/assets/icon-delete-red.svg)] focus:bg-[url(/assets/icon-delete-red.svg)]'
