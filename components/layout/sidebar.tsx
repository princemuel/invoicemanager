import { ProfilePicture, ThemeButton } from 'components/atoms';
...
const Sidebar = (props: Props) => {
  return (
    <aside className='flex h-32 flex-row items-center justify-between bg-primary-600 max-sm:max-w-full md:min-h-screen md:w-36 md:flex-col md:rounded-tr-[2rem]'>
      <Logo />
