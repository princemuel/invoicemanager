...
export type GetInvoicesQuery = { invoices: Array<{ id?: string, tag?: string, paymentDue?: string, clientName?: string, status?: Status, total?: number }> };
...
export type GetInvoiceQuery = { invoice?: { userId?: string, createdAt?: any, updatedAt?: any, paymentDue?: string, tag?: string, description?: string, paymentTerms?: number, clientName?: string, clientEmail?: string, status?: Status, total?: number, senderAddress?: { street: string, city: string, postCode: string, country: string }, clientAddress?: { street: string, city: string, postCode: string, country: string }, items: Array<{ id?: string, name?: string, price?: number, quantity?: number, total?: number }> } };
...
export type CreateInvoiceMutation = { createInvoice: { id?: string, tag?: string, paymentDue?: string, clientName?: string, status?: Status, total?: number } };
...
export type UpdateInvoiceMutation = { updateInvoice?: { updatedAt?: any, paymentDue?: string, tag?: string, description?: string, paymentTerms?: number, clientName?: string, clientEmail?: string, status?: Status, total?: number, senderAddress?: { street: string, city: string, postCode: string, country: string }, clientAddress?: { street: string, city: string, postCode: string, country: string }, items: Array<{ id?: string, name?: string, quantity?: number, price?: number, total?: number }> } };
...
export const useGetInvoicesQuery = <
    ...
    useQuery<GetInvoicesQuery, TError, TData>(
      ...
      fetcher<GetInvoicesQuery, GetInvoicesQueryVariables>(client, GetInvoicesDocument, variables, headers),
      options
    );
...
export const GetInvoiceDocument = /*#__PURE__*/ `
    query GetInvoice($where: ItemWhereUniqueInput!) {
  invoice(where: $where) {
    userId
    createdAt
    updatedAt
...
export const useGetInvoiceQuery = <
    ...
    useQuery<GetInvoiceQuery, TError, TData>(
      ...
      fetcher<GetInvoiceQuery, GetInvoiceQueryVariables>(client, GetInvoiceDocument, variables, headers),
      options
    );
...
export const useCreateInvoiceMutation = <
    ...
    useMutation<CreateInvoiceMutation, TError, CreateInvoiceMutationVariables, TContext>(
      ['CreateInvoice'],
      (variables?: CreateInvoiceMutationVariables) => fetcher<CreateInvoiceMutation, CreateInvoiceMutationVariables>(client, CreateInvoiceDocument, variables, headers)(),
      options
    );
useCreateInvoiceMutation.fetcher = (client: GraphQLClient, variables: CreateInvoiceMutationVariables, headers?: RequestInit['headers']) => fetcher<CreateInvoiceMutation, CreateInvoiceMutationVariables>(client, CreateInvoiceDocument, variables, headers);
export const UpdateInvoiceDocument = /*#__PURE__*/ `
    mutation UpdateInvoice($input: UpdateInvoiceInput!, $where: ItemWhereUniqueInput!) {
...
export const useUpdateInvoiceMutation = <
    ...
    useMutation<UpdateInvoiceMutation, TError, UpdateInvoiceMutationVariables, TContext>(
      ['UpdateInvoice'],
      (variables?: UpdateInvoiceMutationVariables) => fetcher<UpdateInvoiceMutation, UpdateInvoiceMutationVariables>(client, UpdateInvoiceDocument, variables, headers)(),
      options
    );
useUpdateInvoiceMutation.fetcher = (client: GraphQLClient, variables: UpdateInvoiceMutationVariables, headers?: RequestInit['headers']) => fetcher<UpdateInvoiceMutation, UpdateInvoiceMutationVariables>(client, UpdateInvoiceDocument, variables, headers);
...
useRefreshAuthMutation.fetcher = (client: GraphQLClient, variables?: RefreshAuthMutationVariables, headers?: RequestInit['headers']) => fetcher<RefreshAuthMutation, RefreshAuthMutationVariables>(client, RefreshAuthDocument, variables, headers);
