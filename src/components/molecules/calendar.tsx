  ...
  return (
    <div className='relative mt-1'>
      <button
        ...
        onClick={() => setShouldOpen((value) => !value)}
      >
      ...
      >
        ...
        >
          <div className='flex items-center justify-around'>
            ...
            >
              <span className=''>{DateTime.MONTHS[selectedDate.month()]}</span>
                ...
                return (
                  <li
                    ...
                    className={clsx(
                      ...
                      isToday && 'rounded-full bg-accent-200 !text-neutral-100',
                      !isCurrentMonth &&
                        'text-brand-900/30 dark:text-brand-100/30',

                      DateTime.isEqual(selectedDate, date) && 'text-brand-500'
                    )}
                    role='option'
                    onClick={() => {
