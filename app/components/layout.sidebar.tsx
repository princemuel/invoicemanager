...
export function Sidebar() {
  return (
    <aside className="bg-brand-600 max-xs:max-w-full sticky top-0 z-50 flex h-20 flex-row items-center justify-between md:min-h-screen md:w-24 md:flex-col md:rounded-tr-[1.25rem]">
      <Logo />
