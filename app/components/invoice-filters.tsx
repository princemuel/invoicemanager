      ...
      <div className="flex flex-row-reverse items-center gap-3">
        ...
        <div className="relative size-3.5">
          <input
            ...
            className="peer absolute top-0 size-full appearance-none rounded-sm border border-brand-400/25 bg-brand-100 checked:bg-brand-500 hover:border-brand-500 dark:bg-brand-700 dark:checked:bg-brand-500"
          />
